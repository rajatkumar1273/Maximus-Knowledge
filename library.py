...
submit = Button(left_frame, text='Add a new record', font=btn_font, bg=btn_hlb_bg, width=20, command=add_record)
submit.place(x=50, y=375)

clear = Button(left_frame, text='Clear the fields', font=btn_font, bg=btn_hlb_bg, width=20, command=clear_fields)
